 ...
 *
 * שים לב: המבנה שונה כשהטופס קוצר. חמש שאלות הכן/לא הקודמות
 * (קרן פנסיה פעילה, קרן השתלמות, ריבוי מקומות עבודה, ריבוי מוצרים,
 * החלפת עבודה) אוחדו לעמודה אחת בשם situation, שמכילה את כל מה
 * שסומן, מופרד בפסיקים. אם כבר קיים גיליון עם הכותרות הישנות —
 * יש לשנות את שמו או למחוק אותו, אחרת השורות ייכתבו בעמודות שגויות.
 */
var COLUMNS = [
  'submittedAt', 'formType', 'fullName', 'phone', 'email', 'ageRange',
  'topics', 'situation', 'lastReview',
  'contactMethod', 'contactTime', 'notes', 'message', 'consent', 'pageUrl'
];

var HEADERS_HE = [
  'תאריך שליחה', 'סוג טופס', 'שם מלא', 'טלפון', 'אימייל', 'טווח גילאים',
  'נושאים לבדיקה', 'מצב קיים', 'בדיקה אחרונה',
